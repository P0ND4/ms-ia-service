...
@Injectable()
export class DeepseekCompatibleProviderAdapter implements IModelProviderAdapter {
  readonly provider: IaProvider = 'deepseek-compatible';
  ...
  async generateResponse(
    ...
    const summary = [
      ...
      `Objetivo: ${input.goal}`,
      'Respuesta compatible DeepSeek para flujo generico.',
    ].join(' | ');
